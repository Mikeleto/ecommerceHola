...
<div>
    ...
    <div>
        ...
        Categoria<input type="text" wire:model="categoryFilter">
    </div>
</div>
        ...
        @if($products->count())
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    @endif
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        <a href="#" wire:click="sortBy('subcategory_id')">Categoría</a>
                    </th>
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        Estado
                    </th>
                    ...
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        <a href="#" wire:click="sortBy('Unconfirmed')">Pendientes</a>
                    </th>
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        Creado
                    </th>
