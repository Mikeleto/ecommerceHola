...
<x-jet-dropdown>
    ...
    <x-slot name="content">
        ...
        Categoría<input type="checkbox" wire:model="category">
        ...
        En proceso<input type="checkbox" wire:model="to">
        ...
        <div>
            <div>
                Filtrar por nombre:<input type="text" wire:model="nameFilter">
            </div>
         <div>
             Filtrar por categoria
             <button wire:model="categoryFilter">Pulsa guapo</button>
         </div>
        </div>
    </div>
    <x-table-responsive>
        ...
        @if($products->count())
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    @if($category)
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        <a href="#" wire:click="sortBy('subcategory_id')">Categoría/Subcategoría</a>
                    </th>
                        @endif
                        @if($status)
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                    ...
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        ...
                        @if($to)
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                <a href="#" wire:click="sortBy('to')">En proceso</a>
                            </th>
                        @endif
                        @if($created_at)
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
