<div class="container-menu py-8">
    <section class="bg-white rounded-lg shadow-lg p-6 text-gray-700">
            ...
            @foreach(Cart::content() as $item)
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a dusk="bomb" class="ml-6 cursor-pointer hover:text-red-600"
        ...
        <a dusk="omb" class="text-sm cursor-pointer hover:underline mt-3 inline-block"
           wire:click="destroy">
            <i class="fas fa-trash"></i>
    ...
    @if(Cart::count())
        <div class="bg-white rounded-lg shadow-lg px-6 py-4 mt-4">
            <div class="flex justify-between items-center">
                ...
                <div>
                    <x-button-link dusk="truc" href="{{ route('orders.create') }}">
                        Continuar
                    </x-button-link>
                </div>
            </div>
